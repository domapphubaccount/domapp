  ...
  return (
    <div className='h-100 '>
      <div className="carousal_container card_shadow ">
        ...
        >
          <ul>
            <div className='transformed_circle' style={{ transform: `translate(${activeIndex === 1 ? '0px' : activeIndex === 2 ? '105px' : activeIndex === 9 ? '200px' : activeIndex === 3 ? '240px' : activeIndex === 4 ? '384px' : activeIndex === 6 ? "575px" : activeIndex === 7 ? "745px" : '480px'})`, width: activeIndex === 3 ? '140px' : activeIndex === 4 ? '100px' : activeIndex === 5 ? '94px' : activeIndex === 1 ? '110px' : activeIndex === 2 ? '140px' : activeIndex === 6 ? '175px' : activeIndex === 7 && '281px' }}></div>
                      ...
                      <div className="h-100 card_inside">
                        <Row className="h-100">
                          ...
                          <Col sm={8} md={8} lg={8} className={`d-flex align-items-center justify-content-center rounded transformed_video video_col`} >
                            <img loading="lazy" src={item.video} className="rounded h-100 w-100" />
                          </Col>
