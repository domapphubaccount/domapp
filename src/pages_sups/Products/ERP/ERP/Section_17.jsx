...
export default function Section_17() {
  return (
    <section className='erp_section_15'>
        <Container>
            <div className='row g-0 section_container' id="Wor">
            <Col sm={12} md={5} lg={4}>
                        ...
                        <div>
                            <div className='list' data-aos="fade-right"  data-aos-duration="1500">
                                <div className='d-flex'>
                                    ...
                                    <span><img src={yesI.src} className='mx-2' alt='true' /></span> <span>create, customize, and automate business processes.</span>
                                </div>
                                <div className='d-flex'>

                                    <span><img src={yesI.src} className='mx-2' alt='true' /></span> <span>automate routine tasks.</span>
                                </div>
                                <div className='d-flex'>

                                    <span><img src={yesI.src} className='mx-2' alt='true' /></span> <span>Confirm invoice payments.</span>
                                </div>
                                <div className='d-flex'>

                                    <span><img src={yesI.src} className='mx-2' alt='true' /></span> <span>Automate recurring tasks, projects.</span>
                                </div>
                                <div className='d-flex'>

                                    <span><img src={yesI.src} className='mx-2' alt='true' /></span> <span>Automate task, project creation.</span>
                                </div>
                            </div>
                        </div>
                    </div>
