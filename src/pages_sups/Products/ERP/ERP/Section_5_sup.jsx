...
export default function Section_5_sup() {
  return (
        <section className="content-inner-2 overflow-hidden" id="Sub">
            <div className="container">
               <div className="row align-items-center about-bx3">
                ...
                <div className="row" data-wow-delay="1.5s" style={{opacity: "1",transform: "none"}}>
            ...
            <div className="col-lg-6" >
                <div className="dz-media">
                    <img src={Pay.src} className="main-img" data-aos-duration="2500" alt=""/>
                </div>
            </div>
                </div>
                ...
                <div className="col-lg-6">
                        <div className="dz-media">
                            <img src={Time.src} className="main-img" data-aos-duration="2500" alt=""/>
                        </div>
                    </div>
                    <div className="col-lg-6 m-b30" >
                        <div className="section-head" style={{transform: "none"}}>
                    ...
                    <div className="row" data-wow-delay="1.5s" style={{opacity: "1",transform: "none"}}>
                        <div className="col-sm-6">
                            <ul className="list-check-1 light">
                                <li>Create, Modify estimates.
</li>
                                <li>Customized Templates.
</li>
                            </ul>
                        </div>
                        <div className="col-sm-6">
