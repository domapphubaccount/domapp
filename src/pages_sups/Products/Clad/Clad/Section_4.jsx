...
import icon1 from '@/assets/images/Products_Page/Clad/capacity.png'
import icon2 from '@/assets/images/Products_Page/Clad/website.png'
import icon3 from '@/assets/images/Products_Page/Clad/effciency.png'
import icon4 from '@/assets/images/Products_Page/Clad/targeting.png'
import icon5 from '@/assets/images/Products_Page/Clad/reject.png'
    ...
    <section className='py-5'>
        <Container>
            ...
            <div className="col-lg-4">
                <span className="mil-service-card mil-up mil-mb-30 d-inline-block" href="/services/service-2" style={{height:'90%',translate: "none", rotate: "none", scale: "none", transform: "translate(0px, 0px)", opacity: 1}}>
                <div className="mil-card-number">01.</div>
                    <div className="mil-center">
                        ...
                        <p className="mil-service-text">Go from days to minutes for fabrication prep.</p>
            ...
            <div className="col-lg-4">
                ...
                <div className="mil-card-number">02.</div>
                    <div className="mil-center">
                        ...
                        <div className="mil-divider-sm mil-mb-20"></div>
                        <p className="mil-service-text">Intuitive interface simplifies the process.</p>
                        <div className="mil-go-buton mil-icon mil-icon-lg mil-icon-accent-bg">
                            {/* <img src={i1.src} alt="icon"/> */}
                        </div>
                    </div>
            ...
            <div className="col-lg-4">
                ...
                <div className="mil-card-number">05.</div>
                    <div className="mil-center">
                        ...
                        <div className="mil-divider-sm mil-mb-20"></div>
                        <p className="mil-service-text">Rejection drawings ensure a smooth on-site process.</p>
                        <div className="mil-go-buton mil-icon mil-icon-lg mil-icon-accent-bg">
                            {/* <img src={i1.src} alt="icon"/> */}
                        </div>
                    </div>
