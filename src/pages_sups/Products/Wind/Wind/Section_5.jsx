...
export default function Section_5() {
  return (
    <section className="relative my-5">
      <div className="row social-feature-left social-feature-right">
        ...
        <div className="col-md-4 mt-md-5 pt-md-3 mt-4 pt-2">
          <div className="card features feature-primary feature-clean work-process bg-transparent process-arrow border-0 text-center">
            ...
            <div className="card-body">
              <h5 className="text-dark">Site Data</h5>
              <p className="text-muted mb-0">
                Following Saudi Building Code 301, identifying the site data in
                terms of risk category, project address, and exposure category
                is made simple
              </p>
            </div>
          </div>
