...
export default function Bannar() {
  ...
  return (
    <>
      <section
        className="bg-half-260 bg-primary h-screen w-100"
        style={{
            ...
            <div className="col-lg-12 text-center">
              <div className="title-heading leading-6 mb-3" data-aos="fade-up">
                ...
                <div className="mt-4 pt-2">
                  <Link
                    className="btn btn-light d-inline-flex align-items-center mx-2 font-bold"
                    href="https://windmaster.domapphub.com"
                  >
                    {windmaster(lang).sections.bannar.try_btn}
                  </Link>
                  <Link
                    className="btn btn-light d-inline-flex align-items-center mx-2"
