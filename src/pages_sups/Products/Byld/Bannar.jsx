...
function Bannar() {
  return (
    ...
    >
      <div className="container px-4 mx-auto">
        <div className="pt-12 text-center">
          <div className="max-w-2xl mx-auto mb-8 text-center">
            ...
            {/* <h2
              className="text-3xl lg:text-5xl lg:leading-normal mb-4 font-bold font-heading wow animate__ animate__fadeIn animated"
            ...
            <p
              ...
              style={{visibility: "visible", animationName: "fadeIn"}}
            >
              Smart Engineering<strong className="text-blue-500"> Solutions</strong>, just ask <strong className="text-blue-500"> AI</strong>
              {/* <span
                className="typewrite d-inline text-brand"
                data-period="3000"
                data-type='["Web Agency", "Social Marketing" ]'
              >
                <span className="wrap">Social Marketing</span>
              </span> */}
            </p>
          </div>
          <div>
      ...
      <div className="relative max-w-6xl mt-16 md:mt-8 mb-8 mx-auto" data-aos="fade-up">
        <img src="assets/imgs/elements/pattern.png" alt="" style={{minHeight:'600px'}}/>
        <div
          className="absolute"
        ...
        >
          <img
            ...
            src={subBannar.src}
            alt=""
            style={{visibility: "visible", animationName: "jump" , boxShadow: '-1px 5px 20px 0px #111b4a26'}}
          />
        </div>
      </div>
      <div className="container px-4 mx-auto">
        <div className="flex flex-wrap justify-between pt-8 pb-16">
          ...
          >
            ...
            <div className="sm:py-2 ml-2 sm:ml-6">
              ...
              <span className="sm:text-2xl font-bold font-heading count">0</span>
          ...
          >
            ...
            <div className="sm:py-2 ml-2 sm:ml-6">
              <span className="sm:text-2xl font-bold font-heading">+ </span>
              <span className="sm:text-2xl font-bold font-heading count">1</span>
              <p className="text-xs sm:text-base text-blueGray-400">
                Happy Customers
              </p>
            </div>
