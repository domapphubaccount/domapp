    ...
    <Dropdown dir={dir}>
      <Dropdown.Toggle variant="" id="dropdown-basic" className={`${text_color} d-flex align-items-center p-0`}>
        {lang === "ar" ? (
          ...
          >
            <div className="">{arIcon}</div>
            <div className="text-xs	 m-0 mx-1">العربية</div>
          </div>
        ) : (
          <div
            className="d-flex justify-content-between align-items-center"
          >
            <div className="">{enIcon}</div>
            <div className="text-xs	 m-0 mx-1">English</div>
          </div>
        )}
      </Dropdown.Toggle>
